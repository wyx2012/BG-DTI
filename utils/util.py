...
class Helper():
    ...
    # def comput_distance_loss(self,smi_common,fas_common,tag,dg_index,
    # pt_index,ds_common,se_common,dg_dg,dg_se,dg_ds,pt_pt,pt_ds):
    def comput_distance_loss(self, smi_common, fas_common, tag, dg_index, pt_index, dg_dg,pt_pt):
